...
var routes = [
  ...
  {
    path: "routing",
    loadChildren: () => __async(void 0, null, function* () {
      return yield import("./pages-routing-7XUFIMRD.js").then((m) => m.PageRoutes);
    })
  },
  { path: "**", redirectTo: "routing/emp-list", pathMatch: "full" }
];
...
var _InMemoryDataService = class _InMemoryDataService {
  createDb() {
    const employees = [
      {
        id: 1,
...
_InMemoryDataService.\u0275fac = function InMemoryDataService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _InMemoryDataService)();
};
_InMemoryDataService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _InMemoryDataService, factory: _InMemoryDataService.\u0275fac, providedIn: "root" });
var InMemoryDataService = _InMemoryDataService;
...
_AppComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], decls: 3, vars: 0, consts: [[1, "header-style"]], template: function AppComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0);
    \u0275\u0275text(1, " Employee Record Manager\n");
    \u0275\u0275elementEnd();
